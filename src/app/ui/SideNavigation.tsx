import { FilePenLineIcon, PackageIcon, PackageOpenIcon, StoreIcon, WheatIcon } from 'lucide-solid';
	...
	return (
		<aside class="drawer drawer-open h-full">
			...
			<section class="drawer-side">
				<nav class="pt-5 flex flex-col items-center gap-5 min-h-full is-drawer-close:w-0 is-drawer-open:w-64 bg-base-200 transition-all duration-200 ease-in-out">
					<h1 class="text-lg w-full h-10 is-drawer-open:pl-3">
                        {app.isDrawerOpen()
